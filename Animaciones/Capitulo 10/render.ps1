<#
    Renderiza las ocho escenas del capitulo 10 (Procesos Aleatorios) y las
    concatena en un unico video.
...
$escenas = @(
    @{ archivo = 's01_ensemble.py';         escena = 'Ensemble' },
    @{ archivo = 's02_momentos.py';         escena = 'Momentos' },
    @{ archivo = 's03_estacionariedad.py';  escena = 'Estacionariedad' },
    @{ archivo = 's04_oscilador.py';        escena = 'Oscilador' },
    @{ archivo = 's05_autocorrelacion.py';  escena = 'Autocorrelacion' },
    @{ archivo = 's06_ergodicidad.py';      escena = 'Ergodicidad' },
    @{ archivo = 's07_prediccion.py';       escena = 'Prediccion' },
    @{ archivo = 's08_filtrado.py';         escena = 'Filtrado' }
)
...
$final = "salida\Capitulo10-completo-$carpeta.mp4"
