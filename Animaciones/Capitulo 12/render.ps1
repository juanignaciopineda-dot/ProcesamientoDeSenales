<#
    Renderiza las ocho escenas del capitulo 12 (Estimacion de senales /
    filtro de Wiener) y las concatena en un unico video.
...
$escenas = @(
    @{ archivo = 's01_problema.py';        escena = 'ProblemaEstimacion' },
    @{ archivo = 's02_ortogonalidad.py';   escena = 'Ortogonalidad' },
    @{ archivo = 's03_fir.py';             escena = 'WienerFIR' },
    @{ archivo = 's04_no_causal.py';       escena = 'NoCausal' },
    @{ archivo = 's05_senal_en_ruido.py';  escena = 'SenalEnRuido' },
    @{ archivo = 's06_deconvolucion.py';   escena = 'Deconvolucion' },
    @{ archivo = 's07_causal.py';          escena = 'WienerCausal' },
    @{ archivo = 's08_kalman.py';          escena = 'Kalman' }
)
...
$final = "salida\Capitulo12-completo-$carpeta.mp4"
