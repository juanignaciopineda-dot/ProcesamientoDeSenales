<#
    Renderiza las ocho escenas del capitulo 9 y las concatena en un
    unico video.
...
$escenas = @(
    @{ archivo = 's01_pam.py';           escena = 'PAMenRuido' },
    @{ archivo = 's02_map.py';           escena = 'ReglaMAP' },
    @{ archivo = 's03_errores.py';       escena = 'Errores' },
    @{ archivo = 's04_medico.py';        escena = 'TestMedico' },
    @{ archivo = 's05_verosimilitud.py'; escena = 'RazonVerosimilitud' },
    @{ archivo = 's06_neyman.py';        escena = 'NeymanPearson' },
    @{ archivo = 's07_roc.py';           escena = 'CurvaROC' },
    @{ archivo = 's08_riesgo.py';        escena = 'RiesgoMinimo' }
)
...
$final = "salida\Capitulo9-completo-$carpeta.mp4"
