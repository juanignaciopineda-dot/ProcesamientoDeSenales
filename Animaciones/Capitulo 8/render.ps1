<#
    Renderiza las ocho escenas del capitulo 8 y las concatena en un
    unico video.
...
$escenas = @(
    @{ archivo = 's01_mmse.py';           escena = 'MMSE' },
    @{ archivo = 's02_condicional.py';     escena = 'Condicional' },
    @{ archivo = 's03_estimador.py';       escena = 'Estimador' },
    @{ archivo = 's04_lmmse.py';           escena = 'LMMSE' },
    @{ archivo = 's05_rho.py';             escena = 'Correlacion' },
    @{ archivo = 's06_ortogonalidad.py';   escena = 'Ortogonalidad' },
    @{ archivo = 's07_lineal_o_no.py';     escena = 'LinealONo' },
    @{ archivo = 's08_multiples.py';       escena = 'Multiples' }
)
...
$final = "salida\Capitulo8-completo-$carpeta.mp4"
