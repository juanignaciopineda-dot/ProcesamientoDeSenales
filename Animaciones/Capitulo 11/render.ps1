<#
    Renderiza las ocho escenas del capitulo 11 y las concatena en un
    unico video.
...
# OJO: 'Stop' no sirve acá. Manim escribe su progreso por stderr y
...
$escenas = @(
    ...
    @{ archivo = 's02_pasabanda.py';         escena = 'PSDPasabanda' },
    @{ archivo = 's03_dualidad.py';          escena = 'Dualidad' },
    @{ archivo = 's04_bochner.py';           escena = 'Bochner' },
    @{ archivo = 's05_blanco_coloreado.py';  escena = 'BlancoColoreado' },
    @{ archivo = 's06_periodograma.py';      escena = 'Periodograma' },
    @{ archivo = 's07_resolucion.py';        escena = 'Resolucion' },
    @{ archivo = 's08_modelador.py';         escena = 'ModeladorBlanqueador' }
)
...
$final = "salida\Capitulo11-completo-$carpeta.mp4"
